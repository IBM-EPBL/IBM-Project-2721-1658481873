...
src_path = os.path.join(get_parent_dir(1), "/content/drive/MyDrive/IBM_PROJECT/yolo_structure/2_Training/src")
utils_path = os.path.join(get_parent_dir(1), "/content/drive/MyDrive/IBM_PROJECT/yolo_structure/Utils")
